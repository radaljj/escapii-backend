...
class GiftFlowEndToEndTest {
    ...
    void setUp() throws Exception {
        ...
        invoiceMail  = new InvoiceEmailServiceImpl(sender);            set(invoiceMail,  "contactEmail", "info@escapii.rs");
        ...
        docMail      = new ConfirmationDocumentEmailServiceImpl(sender); set(docMail,    "contactEmail", "info@escapii.rs");
